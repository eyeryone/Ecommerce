package com.liuser.Ecommerce

import java.text.SimpleDateFormat
import java.util.UUID

import com.liuser.Ecommerce.common.bean.{CityInfo, ProductInfo, UserInfo, UserVisitAction}
import com.liuser.Ecommerce.util.{RanOpt, RandomDate, RandomNum, RandomOptions}
